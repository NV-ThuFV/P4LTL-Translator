...
/**
  Information about all the input sources that comprise a P4 program that is
  being compiled. The inputSources can be seen as a simple file produced by the
  preprocessor, but also as a set of fragments of input files which were
  stitched by the preprocessor.
  ...
  This class implements a singleton pattern: there is a single instance of this
  class.
*/
